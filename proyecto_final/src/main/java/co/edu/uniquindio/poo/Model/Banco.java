...
public class Banco {
    ...
    private Banco() {
        ...
        Administrador admin = new Administrador("Ana Admin", "admin1", "Oficina 1", "3000000000", "EMP001", 5000000, "adminpass");
        Cajero cajero = new Cajero("Luis Cajero", "cajero1", "Sucursal 2", "3000001111", "EMP002", 2500000, "cajeropass");
    ...
    public void registrarTransaccion(Transaccion transaccion) {
        ...
        System.out.println("Transacción registrada: " + transaccion.getCodigoTransaccion() + " - Monto: " + transaccion.getMonto());
    }
    ...
    public void registrarCajero(String nombre, String identificacion, String direccion, String telefono, String idEmpleado, double salario, String pin) {
    ...
    public void registrarAdministrador(String nombre, String identificacion, String direccion, String telefono, String idEmpleado, double salario, String pin) {
